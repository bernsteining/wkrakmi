...
* @param {string} flag
*/
__exports.check_flag = function(flag) {
    var ptr0 = passStringToWasm0(flag, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    wasm.check_flag(ptr0, len0);
};
...
*/
__exports.inject_html = function(input, document, element) {
    var ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    wasm.inject_html(ptr0, len0, addHeapObject(document), addHeapObject(element));
};
